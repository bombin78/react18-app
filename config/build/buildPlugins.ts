...
export function buildPlugins({
    ...
    const plugins = [
        ...
        // Плагин для поиска циклических зависимостей
        // https://www.npmjs.com/package/circular-dependency-plugin
        new CircularDependencyPlugin({
            exclude: /node_modules/,
            failOnError: true,
        }),
        // Плагин для запуска проверки типов TypeScript в отдельном процессе
        // https://github.com/TypeStrong/fork-ts-checker-webpack-plugin/tree/main
